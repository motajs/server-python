...
def usefspy():
    with open('editor.html',encoding='utf-8') as fid:
        out=fid.read()
        out=out.replace("<script src='_server/fs.js'></script>","<script src='_server/fs_py.js'></script>").replace('./editor-mobile.html','./editor-mobile_py.html')
        with open('editor_py.html','w',encoding='utf-8') as fid2:
            fid2.write(out)
    with open('editor-mobile.html',encoding='utf-8') as fid:
        out=fid.read()
        out=out.replace("<script src='_server/fs.js'></script>","<script src='_server/fs_py.js'></script>").replace('./editor.html','./editor_py.html')
        with open('editor-mobile_py.html','w',encoding='utf-8') as fid2:
            fid2.write(out)
